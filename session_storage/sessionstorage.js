// membuat session storage key
const sessionStorageKey = "PRESS_FREQUENCY";

// pengecekan apakah data session storage dengan key count tersedia atau belum
if (typeof Storage !== "undefined") {
  ...
  alert("Browser yang Anda Gunakan tidak Support Web Storag");
}
